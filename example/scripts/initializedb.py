...
def add_mptt_pages():
    ...
    """
    pages = (
        {'id': '1', 'visible': True, 'parent_id': None},
        {'id': '2', 'visible': True, 'parent_id': '1'},
        {'id': '3', 'visible': True, 'parent_id': '2'},
        {'id': '4', 'visible': False, 'parent_id': '1'},
        {'id': '5', 'visible': True, 'parent_id': '4'},
        {'id': '6', 'visible': False, 'parent_id': '4'},
        {'id': '7', 'visible': True, 'parent_id': '1'},
        {'id': '8', 'visible': True, 'parent_id': '7'},
        {'id': '9', 'visible': False, 'parent_id': '8'},
        {'id': '10', 'visible': True,  'parent_id': '7'},
        {'id': '11', 'visible': True,  'parent_id': '10'},

        {'id': '12', 'visible': True, 'parent_id': None, 'tree_id': '12'},
        {'id': '13', 'visible': False, 'parent_id': '12', 'tree_id': '12'},
        {'id': '14', 'visible': False, 'parent_id': '13', 'tree_id': '12'},
        {'id': '15', 'visible': True, 'parent_id': '12', 'tree_id': '12'},
        {'id': '16', 'visible': True, 'parent_id': '15', 'tree_id': '12'},
        {'id': '17', 'visible': True, 'parent_id': '15', 'tree_id': '12'},
        {'id': '18', 'visible': True, 'parent_id': '12', 'tree_id': '12'},
        {'id': '19', 'visible': True, 'parent_id': '18', 'tree_id': '12'},
        {'id': '20', 'visible': True, 'parent_id': '19', 'tree_id': '12'},
        {'id': '21', 'visible': True, 'parent_id': '18', 'tree_id': '12'},
        {'id': '22', 'visible': True, 'parent_id': '21', 'tree_id': '12'},
    )
